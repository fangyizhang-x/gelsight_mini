...
def main(argv):
    ...
    rospy.init_node('showmini3dros_right', anonymous=True)
    ...
    dev = gsdevice.Camera("GelSight Mini R0B 28EY-D5VM")
    # print(dev)
    ...
    if PUBLISH_ROS_PC:
        ...
        gelpcd_pub = rospy.Publisher("/gsmini_pcd_right", PointCloud2, queue_size=10)
