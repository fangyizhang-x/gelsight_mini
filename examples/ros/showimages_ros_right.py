...
if __name__ == '__main__':
    ...
    rospy.init_node('twogsminiros_right', anonymous=True)
    ...
    for i in range(NUM_SENSORS):
        gs['gsmini_pub'][i] = rospy.Publisher("/gsmini_rawimg_right", Image, queue_size=1)
        gs['vs'][i] = WebcamVideoStream(8).start() # make sure the id numbers of the cameras are ones recognized by the computer. Default, 2 and 4
...
# n10875425@thor-gpu:~/gelsightmini/examples$ cd ros/
# n10875425@thor-gpu:~/gelsightmini/examples/ros$ python3 showimages_ros.py 
# [ WARN:0@0.314] global cap_v4l.cpp:982 open VIDEOIO(V4L2:/dev/video2): can't open camera by index
# [ERROR:0@0.639] global obsensor_uvc_stream_channel.cpp:156 getStreamChannelGroup Camera index out of range
# Traceback (most recent call last):
#   File "showimages_ros.py", line 115, in <module>
#     gs['img'][i] = gs['vs'][i].read()
#   File "showimages_ros.py", line 70, in read
#     frame = self.frame.copy()
