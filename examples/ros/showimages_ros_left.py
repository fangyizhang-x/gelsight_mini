...
if __name__ == '__main__':
    ...
    rospy.init_node('twogsminiros_left', anonymous=True)
    ...
    for i in range(NUM_SENSORS):
        gs['gsmini_pub'][i] = rospy.Publisher("/gsmini_rawimg_left", Image, queue_size=1)
        gs['vs'][i] = WebcamVideoStream(6).start() # make sure the id numbers of the cameras are ones recognized by the computer. Default, 2 and 4
