...
def main(argv):
    ...
    rospy.init_node('showmini3dros_left', anonymous=True)
    ...
    dev = gsdevice.Camera("GelSight Mini R0B 28EA-WFXV")
    # print(dev)
    ...
    if PUBLISH_ROS_PC:
        ...
        gelpcd_pub = rospy.Publisher("/gsmini_pcd_left", PointCloud2, queue_size=10)
